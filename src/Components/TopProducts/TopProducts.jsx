      ...
      <div className="container">
        ...
        <div className="text-left mb-24 ">
          ...
          <p data-aos="fade-up" className="text-xs text-gray-400">
            ...
            doloremque est fuga cumque, voluptate dolorum.
          </p>
        </div>

        {/* body section */}
        <div className=" grid grid-cols-1 sm:grid-cols-3 md:grid-cols-3 gap-6 place-items-center ">
          {ProductsData.map((data) => (
            <div data-aos="zoom-in" className="rounded-2xl bg-white dark:bg-gray-800 hover:bg-black/80 dark:hover:bg-primary hover:text-white relative shadow-xl duration-300 group max-w-[300px] ">
              ...
              <div className="h-[150px] ">
                <img
                  src={data.img}
                  className="max-w-[140px] block mx-auto transform-translate-20 group-hover:scale-125 duration-300 drop-shadow-md"
                />
              </div>
              {/* detail section */}
              <div className=" text-center p-4">
                ...
                <p className="text-gray-500 group-hover:texxt-white duration-300 text-sm line-clam-2">{data.description}</p>
